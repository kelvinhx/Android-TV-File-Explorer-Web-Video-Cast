    ...
    fun getLocalVersionInfo(context: Context): JSONObject {
        return try {
            ...
            try {
                ...
                fallback.put("versionName", pInfo.versionName ?: "1.1.8")
                fallback.put("buildDateTime", "2026-06-11T18:20:00Z")
            } catch (ex: Exception) {
                fallback.put("versionCode", 10L)
                fallback.put("versionName", "1.1.8")
                fallback.put("buildDateTime", "2026-06-11T18:20:00Z")
            }
            fallback
        }
